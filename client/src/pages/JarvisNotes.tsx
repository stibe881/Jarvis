        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {notes?.map(note => (
              <div
                key={note.id}
                className="jarvis-card rounded-xl p-4 flex flex-col gap-3 group hover:border-primary/30 transition-all"
              >
                ...
                <p className="text-muted-foreground text-xs line-clamp-4 flex-1">
                  {note.content}
                </p>
                {note.tags && (
